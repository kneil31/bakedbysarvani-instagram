...
<head>
  ...
  <style>
    *, *::before, *::after {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    :root {{
      /* ── Honeybear-inspired: white, soft coral, generous, feminine ── */
    ...
    /* ── Header — Honeybear: serif, generous, soft ── */
    .header {{ text-align: center; padding: 9vw 24px 6vw; }}
    .header h1 {{ font-family: var(--font-display); font-size: 34px; font-weight: 400; color: var(--text); letter-spacing: 0.3px; margin-bottom: 16px; line-height: 1.3; }}
    .header h1 span {{ color: var(--pink); }}
    .header .tagline {{ font-size: 15px; color: var(--text-mid); font-weight: 400; line-height: 1.7; max-width: 320px; margin: 0 auto 20px; }}
    .header .loc {{ font-size: 11px; color: var(--text-light); text-transform: uppercase; letter-spacing: 3px; font-weight: 500; }}
    ...
    /* ── Reviews — clean cards, soft accent ─────── */
    .section-title {{ font-family: var(--font-display); font-size: 26px; font-weight: 400; color: var(--text); text-align: center; margin-bottom: 6px; }}
    ...
    .review-text::before {{ content: '\\201C'; font-family: var(--font-display); font-size: 32px; color: var(--coral); font-weight: 400; line-height: 0; position: relative; top: 10px; margin-right: 4px; }}
    ...
    .order-header h2 {{ font-family: var(--font-display); font-size: 26px; font-weight: 400; color: var(--text); margin-bottom: 8px; }}
    ...
    .footer .brand {{ font-family: var(--font-display); font-size: 18px; font-weight: 400; color: var(--text); margin-bottom: 8px; }}
